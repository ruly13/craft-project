    ...
    <section className="py-20 px-6 bg-white">
      <div className="container mx-auto">
        <div className="flex items-center justify-between mb-12">
          <h2 className="text-3xl font-bold font-serif text-stone-900">Kategori Pilihan</h2>
          <Link href="#" className="text-emerald-600 font-medium flex items-center gap-2 hover:gap-3 transition-all">
