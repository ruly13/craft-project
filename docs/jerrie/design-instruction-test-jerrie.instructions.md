...
// src/app/company-profile/page.js
...
2. **Check `src/components/Badge/index.js`** → Exports: `BadgeStatus`, `TagBubble`, `BadgeStatusPesanan`, `BadgeSOSPopover`
...
- **If ANY visual mismatch → NOT VALID → Use primitives**
  ...
  "BadgeStatusPesanan": "A fixed-size status badge for order status with optional icons and standardized dimensions; **Crucial Rule:** ALWAYS maintains a fixed width of 176px and height of 40px and NEVER resizes dynamically.",
